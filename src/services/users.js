...
import { signInWithEmailAndPassword, createUserWithEmailAndPassword, signOut, signInWithRedirect, GoogleAuthProvider } from "firebase/auth";
...
const createSesion=(id)=>{
    const sesion=makeId();
    updateUser(id,{sesion});
    return sesion;
};
const makeId=()=>{
    let result = '';
